    ...
    doRender() {
        ...
        <div class="ai-providers-section options-section">
            ...
            <div class="form-group">
                ...
                <input type="text" class="ai-provider-precedence form-control" placeholder="e.g., openai,anthropic,ollama">
        ...
        <div class="embedding-section options-section">
            ...
            <div class="form-group">
                ...
                <input type="text" class="embedding-provider-precedence form-control" placeholder="e.g., openai,voyage,ollama">
