...
export function isRecoveryCodeSet() {
    return optionService.getOptionBool('encryptedRecoveryCodes');
}

export function setRecoveryCodes(recoveryCodes: string) {
...
export function verifyRecoveryCode(recoveryCodeGuess: string) {
...
export function getUsedRecoveryCodes() {
    if (!isRecoveryCodeSet()){
